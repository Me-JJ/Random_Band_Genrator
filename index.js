//Extracting random words from 2 different arrays
// on server side to generate the Band Name and passing it to the wesite 
//throght responce.render() using NodeJs with Express and Body-PArser.
//Using Embedded Js fro templating the web site dynamically.
...
app.post("/submit", (req, res) => {
  ...
  let word2=noun[(Math.floor(Math.random() * noun.length))];

  const bandName=word1+" "+word2;
